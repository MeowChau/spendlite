...
abstract class TxnRepository {
  ...
  Future<Txn> add({required DateTime time, required String category, required int amount, String? note});
...
class TxnRepositoryImpl implements TxnRepository {
  ...
  @override
  Future<Txn> add({required DateTime time, required String category, required int amount, String? note}) async {
